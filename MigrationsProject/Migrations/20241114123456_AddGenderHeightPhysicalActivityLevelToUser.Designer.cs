...
namespace MigrationsProject.Migrations
{
    ...
    [Migration("20241114123456_AddGenderHeightPhysicalActivityLevelToUser")]
    partial class AddGenderHeightPhysicalActivityLevelToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Database.ExerciseMedium", b =>
                {
            ...
            modelBuilder.Entity("DataAccess.Database.ExerciseMuscle", b =>
                {
                    b.Property<int>("ExerciseId")
                        .HasColumnType("integer")
                        .HasColumnName("exercise_id");
                    ...
                    b.HasKey("ExerciseId", "MuscleGroup")
                        .HasName("exercise_muscles_pkey");

                    b.ToTable("exercise_muscles");
                });

            modelBuilder.Entity("DataAccess.Database.ExerciseReview", b =>
                {
                    ...
                    b.HasKey("ReviewId")
                        .HasName("exercise_reviews_pkey");

                    b.HasIndex("ExerciseId");

                    b.HasIndex("UserId");

                    b.ToTable("exercise_reviews");
                });
            ...
            modelBuilder.Entity("DataAccess.Database.ExerciseMuscle", b =>
                {
                    b.HasOne("DataAccess.Database.Exercise", "Exercise")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("exercise_muscles_exercise_id_fkey");
            ...
            modelBuilder.Entity("DataAccess.Database.ExerciseReview", b =>
                {
                    b.HasOne("DataAccess.Database.Exercise", "Exercise")
                        ...
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("exercise_reviews_exercise_id_fkey");

                    b.HasOne("DataAccess.Database.User", "User")
                        .WithMany("ExerciseReviews")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("exercise_reviews_user_id_fkey");
