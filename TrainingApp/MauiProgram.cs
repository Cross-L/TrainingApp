...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddDbContext<ApplicationDbContext>(options =>
            options.UseNpgsql($"Host={host};Port=5432;Database=TrainingDatabase;Username=postgres;Password=111222333",
        ...
        Locator.CurrentMutable.Register(() => new RegistrationContinuationPage(), typeof(IViewFor<RegistrationContinuationViewModel>));
        ...
        Locator.CurrentMutable.Register(() => new SubscribedWorkoutsPage(), typeof(IViewFor<SubscribedWorkoutsViewModel>));
